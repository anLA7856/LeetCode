...
public class HashMap<K,V> extends AbstractMap<K,V>
    ...
    /**
     * 当由链表转为树时候，此时Hash表的最小容量。
     * 也就是如果没有到64的话，就会进行resize的扩容操作。
    ...
    /**
     * 构造方法
     * initialCapacity找到一个最适合的2的倍数的大小
     */
    ...
    /**
     * 根据key返回值。
     * 也就是先算hash，在找到其位置，在看是否有因冲突而产生的链表或者二叉树。
     */
    ...
    static final class TreeNode<K,V> extends LinkedHashMap.Entry<K,V> {
        ...
        TreeNode<K,V> left;
        TreeNode<K,V> right;
        TreeNode<K,V> prev;    // needed to unlink next upon deletion，删除时记得置null
        boolean red;
        ...
        /**
         * 根据hash即参数h，和object key即k，找到相应的二叉树节点。
